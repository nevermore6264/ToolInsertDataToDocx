...
public class PriceListManager {
    ...
    public static List<Product> getNamPriceList() {
        ...
        products.add(new Product("2",
            "Que thử xét nghiệm định tính MET(MAMP)-THC-MOR-MDMA trong nước tiểu, HSX: Shanghai Chemtron Biotech Co.,Ltd  \n(4.1)\n- Morphine/ Heroin (MOP/OPI)\n- Cần sa (THC)\n- Ma túy đá (MET)\n- Thuốc lắc (ECSTASY/MDMA)\nModel: 74716",
            "Chemtron Biotech \nThương hiệu: Mỹ\nXuất xứ: Trung Quốc",
            "Hộp 25 Test",
            "Test",
            60800));
        ...
        products.add(new Product("4",
            "Que thử xét nghiệm định tính Cỏ Mỹ trong nước tiểu, HSX: Shanghai Chemtron Biotech Co.,Ltd  \n(K2)\nModel: 7021S",
            "Chemtron Biotech \nThương hiệu: Mỹ\nXuất xứ: Trung Quốc",
            "Hộp 50 Test",
            "Test",
            22000));
        ...
        products.add(new Product("5",
            "Que thử xét nghiệm định tính Morphine trong nước tiểu, HSX: Shanghai Chemtron Biotech Co.,Ltd  \n(MOP)\nModel: 7001S",
            "Chemtron Biotech \nThương hiệu: Mỹ\nXuất xứ: Trung Quốc",
            "Hộp 50 Test",
            "Test",
            22000));
        ...
        products.add(new Product("6",
            "Que thử xét nghiệm định tính Methamphetamine trong nước tiểu, HSX: Shanghai Chemtron Biotech Co.,Ltd \n(MET)\nModel: 7004S",
            "Chemtron Biotech \nThương hiệu: Mỹ\nXuất xứ: Trung Quốc",
            "Hộp 50 test",
            "Test",
            22000));
        ...
        products.add(new Product("7",
            "Que thử xét nghiệm định tính Marijuana (THC) trong nước tiểu, HSX: Shanghai Chemtron Biotech Co.,Ltd \n(THC)\nModel: 7005S",
            "Healgen – Mỹ/China\nAssuretech \n–  Hà Lan / China\n ",
            "Hộp 100 Test\nHộp 50 Test",
            "Test",
            22000));
